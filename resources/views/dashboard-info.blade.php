...
<script>
  document.addEventListener("DOMContentLoaded", function() {
    // 1. VERIFICAR CARGA DE APEXCHARTS
    if (typeof ApexCharts === 'undefined') {
      console.error('ApexCharts no se cargó correctamente');
      return;
    }

    // PRIMER GRÁFICO CORREGIDO (usar "column" en lugar de "bar")
    const options1 = {
      colors: ["#1A56DB"],
      series: [{
        name: "Ventas",
