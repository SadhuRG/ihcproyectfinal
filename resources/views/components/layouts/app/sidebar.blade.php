        ...
        <flux:sidebar sticky stashable class="border-e border-zinc-200 bg-zinc-50 :border-zinc-700 :bg-zinc-900">
            ...
            <flux:navlist variant="outline">
                <flux:navlist.group :heading="__('Platform')" class="grid">
                    <flux:navlist.item icon="home" :href="route('welcome')" :current="request()->routeIs('welcome')" wire:navigate>{{ __('welcome') }}</flux:navlist.item>
                </flux:navlist.group>
            </flux:navlist>
                        ...
                        <div class="p-0 text-sm font-normal">
                            <div class="flex items-center gap-2 px-1 py-1.5 text-start text-sm">
                                <span class="relative flex h-8 w-8 shrink-0 overflow-hidden rounded-lg">
                                    <span
                                        class="flex h-full w-full items-center justify-center rounded-lg bg-neutral-200 text-black :bg-neutral-700 :text-white"
                                    >
                                        {{ auth()->user()->initials() }}
                                    </span>
                                </span>
