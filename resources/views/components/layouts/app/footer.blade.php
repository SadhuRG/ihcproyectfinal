...
<body>
<!-- FOOTER -->
<footer class="w-full bg-gradient-to-r from-indigo-900 via-purple-900 to-indigo-800 relative overflow-hidden">
    <!-- Background Pattern -->
    ...
    <div class="relative z-10 px-6 py-12">
        ...
        <div class="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div class="md:col-span-2">
                <div class="flex items-center space-x-3 mb-4">
                    ...
                    <span class="text-white text-2xl font-bold">Pulsar</span>
                </div>
            ...
            <div>
                ...
                <ul class="space-y-2">
                    <li><a href="#" class="text-gray-300 hover:text-white transition-colors duration-300 text-sm">Inicio</a></li>
                    <li><a href="#" class="text-gray-300 hover:text-white transition-colors duration-300 text-sm">Catálogo</a></li>
                    <li><a href="#" class="text-gray-300 hover:text-white transition-colors duration-300 text-sm">Best Sellers</a></li>
                    <li><a href="#" class="text-gray-300 hover:text-white transition-colors duration-300 text-sm">Ofertas</a></li>
                    <li><a href="#" class="text-gray-300 hover:text-white transition-colors duration-300 text-sm">Mi Cuenta</a></li>
                </ul>
            </div>
        ...
        <!-- Newsletter Section -->
        <div class="max-w-6xl mx-auto border-t border-gray-700 pt-8 mb-8">
            <div class="text-center">
                <h3 class="text-white font-semibold text-lg mb-2">Suscríbete a nuestro newsletter</h3>
                <p class="text-gray-300 text-sm mb-4">Recibe las últimas novedades y ofertas especiales</p>
                <div class="flex flex-col sm:flex-row justify-center items-center space-y-2 sm:space-y-0 sm:space-x-2 max-w-md mx-auto">
                    <input type="email" placeholder="Tu email"
                           class="w-full sm:flex-1 px-4 py-2 bg-white/10 backdrop-blur-sm border border-gray-600 rounded-full text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-white/50 focus:border-transparent">
                    <button class="w-full sm:w-auto px-6 py-2 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white font-medium rounded-full transition-all duration-300 hover:scale-105">
                        Suscribirse
                    </button>
                </div>
            </div>
