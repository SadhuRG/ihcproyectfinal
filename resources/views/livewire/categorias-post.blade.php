<div>
            ...
            <div class="flex justify-between mt-3 gap-8 items-center">
                ...
                <div class="flex items-center gap-4 ml-4 mt-3">
                    <button wire:click="eliminarshowmodal"
                        class="px-4 py-3 mb-4 flex items-center justify-center font-semibold rounded-lg shadow-md transition-all duration-200 transform hover:scale-105 border-2 {{ count($selectedCategorias) >= 2 ? 'bg-white hover:bg-red-400 text-black border-black cursor-pointer' : 'bg-gray-300 text-gray-500 border-gray-300 cursor-not-allowed opacity-50' }}"
        ...
        <div class="bg-white p-6 rounded-lg shadow-xl max-w-md w-full mx-4 max-h-[90vh] overflow-y-auto">
            ...
            <form wire:submit.prevent="crearCategoria" class="space-y-4">
                <div>
                    ...
                    @error('nuevaCategoria.nombre') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                </div>
            ...
            <form wire:submit.prevent="guardarCategoria" class="space-y-4">
                <div>
                    ...
                    <input type="text" wire:model="categoriaEditada.nombre" required
                        class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                    @error('categoriaEditada.nombre') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                </div>
    ...
    <div class="fixed inset-0 bg-black/50 flex items-start justify-center z-50 pt-4">
        <div class="bg-white p-6 rounded-lg shadow-xl max-w-md w-full mx-4">
            ...
            <p class="mb-6">¿Estás seguro de eliminar esta categoría? Esta acción no se puede deshacer.</p>
            ...
            @else
            <p class="mb-6">¿Estás seguro de eliminar estas {{ count($selectedCategorias) }} categorías? Esta acción no se puede deshacer.</p>
            <div class="flex justify-end space-x-4">
                <button wire:click="cancelarEliminacion"
                    class="px-4 py-2 bg-gray-300 text-gray-800 rounded hover:bg-gray-400 transition-colors">
                    Cancelar
