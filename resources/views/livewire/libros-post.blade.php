<div>
                        ...
                        <tbody>
                            ...
                            <tr class="bg-white border-b hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4">
                                    ...
                                    @endphp
                                    <span class="block {{ $cantidad <= $umbral ? 'text-red-600 font-semibold' : 'text-gray-900' }}">
                                        {{ $cantidad }} unidades
                                    </span>
                                    <span class="text-xs text-gray-500">Umbral: {{ $umbral }}</span>
                                </td>

                                <td class="px-6 py-4">
                                    <span class="text-sm">{{ Str::limit($libro->descripcion, 50) }}</span>
                                </td>
            ...
            <div class="flex justify-between mt-3 gap-8 items-center">
                ...
                <div class="flex items-center gap-4 ml-4 mt-3">
                    <button wire:click="eliminarshowmodal"
                        class="px-4 py-3 mb-4 flex items-center justify-center font-semibold rounded-lg shadow-md transition-all duration-200 transform hover:scale-105 border-2 {{ count($selectedLibros) >= 2 ? 'bg-white hover:bg-red-400 text-black border-black cursor-pointer' : 'bg-gray-300 text-gray-500 border-gray-300 cursor-not-allowed opacity-50' }}"
            ...
            <form wire:submit.prevent="crearLibro" class="space-y-4">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        @error('nuevoLibro.titulo') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" wire:model="nuevoLibro.ISBN" required
                            class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                        @error('nuevoLibro.ISBN') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>
                </div>
                ...
                <div>
                    ...
                    @error('nuevoLibro.descripcion') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <small class="text-gray-500">Mantén Ctrl/Cmd para seleccionar múltiples autores</small>
                    </div>
                    ...
                    <div>
                        ...
                        <small class="text-gray-500">Mantén Ctrl/Cmd para seleccionar múltiples categorías</small>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                        ...
                        @error('nuevoLibro.editorial_id') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" wire:model="nuevoLibro.precio" required
                            class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                        @error('nuevoLibro.precio') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" wire:model="nuevoLibro.cantidad" required
                            class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                        @error('nuevoLibro.cantidad') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>
                </div>

                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Umbral de Stock *</label>
                    <input type="number" wire:model="nuevoLibro.umbral" required
                        class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                    @error('nuevoLibro.umbral') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                </div>
    ...
    <div class="fixed inset-0 bg-black bg-opacity-50 flex items-start justify-center z-50 pt-4">
        <div class="bg-white p-6 rounded-lg shadow-xl max-w-2xl w-full mx-4 max-h-[90vh] overflow-y-auto">
            <div class="flex justify-between items-center mb-4">
                <h3 class="text-lg font-semibold">Editar Libro</h3>
            ...
            <form wire:submit.prevent="guardarLibro" class="space-y-4">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" wire:model="libroEditado.titulo" required
                            class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                        @error('libroEditado.titulo') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>
                ...
                <div>
                    ...
                    <textarea wire:model="libroEditado.descripcion" rows="3"
                        class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"></textarea>
                    @error('libroEditado.descripcion') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                        ...
                        @error('libroEditado.editorial_id') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" wire:model="libroEditado.precio" required
                            class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                        @error('libroEditado.precio') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" wire:model="libroEditado.cantidad" required
                            class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                        @error('libroEditado.cantidad') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>
                </div>
                ...
                <div>
                    ...
                    <input type="number" wire:model="libroEditado.umbral" required
                        class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                    @error('libroEditado.umbral') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                </div>
    ...
    <div class="fixed inset-0 bg-black bg-opacity-50 flex items-start justify-center z-50 pt-4">
        <div class="bg-white p-6 rounded-lg shadow-xl max-w-md w-full mx-4">
            ...
            <p class="mb-6">¿Estás seguro de eliminar este libro? Esta acción también eliminará sus ediciones e inventarios asociados.</p>
            ...
            @else
            <p class="mb-6">¿Estás seguro de eliminar estos {{ count($selectedLibros) }} libros? Esta acción también eliminará sus ediciones e inventarios asociados.</p>
            <div class="flex justify-end space-x-4">
                <button wire:click="cancelarEliminacion"
                    class="px-4 py-2 bg-gray-300 text-gray-800 rounded hover:bg-gray-400 transition-colors">
                    Cancelar
