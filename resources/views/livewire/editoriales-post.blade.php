<div>
                    ...
                    <table class="w-full text-sm text-left text-gray-500">
                        ...
                        <tbody>
                            ...
                            <tr class="bg-white border-b hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4">
                                    <span class="font-medium text-gray-900">{{ $editorial->nombre }}</span>
                                </td>
            ...
            <div class="flex justify-between mt-3 gap-8 items-center">
                ...
                <div class="flex items-center gap-4 ml-4 mt-3">
                    <button wire:click="eliminarshowmodal"
                        class="px-4 py-3 mb-4 flex items-center justify-center font-semibold rounded-lg shadow-md transition-all duration-200 transform hover:scale-105 border-2 {{ count($selectedEditoriales) >= 2 ? 'bg-white hover:bg-red-400 text-black border-black cursor-pointer' : 'bg-gray-300 text-gray-500 border-gray-300 cursor-not-allowed opacity-50' }}"
    ...
    <div class="fixed inset-0 bg-black bg-opacity-50 flex items-start justify-center z-50 pt-4">
        <div class="bg-white p-6 rounded-lg shadow-xl max-w-md w-full mx-4">
            <div class="flex justify-between items-center mb-4">
                <h3 class="text-lg font-semibold">Crear Nueva Editorial</h3>
            ...
            <form wire:submit.prevent="crearEditorial" class="space-y-4">
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Nombre de la Editorial *</label>
                    <input type="text" wire:model="nuevaEditorial.nombre" required
                        class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                    @error('nuevaEditorial.nombre') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                </div>
    ...
    <div class="fixed inset-0 bg-black bg-opacity-50 flex items-start justify-center z-50 pt-4">
        <div class="bg-white p-6 rounded-lg shadow-xl max-w-md w-full mx-4">
            <div class="flex justify-between items-center mb-4">
                <h3 class="text-lg font-semibold">Editar Editorial</h3>
            ...
            <form wire:submit.prevent="guardarEditorial" class="space-y-4">
                <div>
                    ...
                    <input type="text" wire:model="editorialEditada.nombre" required
                        class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                    @error('editorialEditada.nombre') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                </div>
    ...
    <div class="fixed inset-0 bg-black bg-opacity-50 flex items-start justify-center z-50 pt-4">
        <div class="bg-white p-6 rounded-lg shadow-xl max-w-md w-full mx-4">
            ...
            <p class="mb-6">¿Estás seguro de eliminar esta editorial? Esta acción no se puede deshacer.</p>
            ...
            @else
            <p class="mb-6">¿Estás seguro de eliminar estas {{ count($selectedEditoriales) }} editoriales? Esta acción no se puede deshacer.</p>
            <div class="flex justify-end space-x-4">
                <button wire:click="cancelarEliminacion"
                    class="px-4 py-2 bg-gray-300 text-gray-800 rounded hover:bg-gray-400 transition-colors">
                    Cancelar
